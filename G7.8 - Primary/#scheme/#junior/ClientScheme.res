"Scheme"
{
	"Colors"
	{
		"FontNormal"				"255 255 255 255"		// most of HUD text
		"FontDarker"				"150 150 150 255"
		"FontHighlight"			"255 200  55 255"
		"FontPositive"				"255 200  55 255"
		"FontNegative"				"255 200  55 255"

		"MenuSideBarFg"				"255 255 255 100"
		"MenuSideBarBg"				"255 255 255  50"

		"MenuPanelFg"				"255 255 255 100"		// other main menu elements
		"MenuPanelBg"				"255 255 255 50"		// panels in main menu

		"BackpackPanelFg"			" 10  10  10 250"		// like menu ^, but has to cover what's under it
		"BackpackPanelBg"			" 25  25  25 250"

		"TooltipFg"					"200 200 200 255"
		"TooltipBg"					"  0   0   0 150"		// tooltips when hovering over elements


		"ButtonNormalFg"			"255 255 255 255"
		"ButtonNormalBg"			"255 255 255 120"

		"ButtonHoverFg"			"255 200  55 255"
		"ButtonHoverBg"			"255 200  55 150"

		"ButtonWarningFg"			"230   0   0 180"		// buttons like Quit, Delete, Reset, etc.
		"ButtonWarningBg"			"190  25  25 180"

		"ButtonConfirmFg"			"120 190  60 150"		// Start search, Accept, etc.
		"ButtonConfirmBg"			" 94 150  49 150"

		"PartyHighlight"			" 94 150  49 255"		// hovering party members
